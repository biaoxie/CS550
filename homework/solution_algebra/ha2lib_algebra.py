...
def ha2(univDB):
    ...
    # total student - student not satisfy prereq
    ...
    # OK query_h pre-req && this semester
    
    prereq_class = ra.join(prereq, class_)

    query_h = ra.proj(prereq_class, ['class', 'dcode','cno','instr'])
